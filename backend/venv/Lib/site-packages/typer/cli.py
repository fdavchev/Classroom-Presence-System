...
add_typer(utils_app, name="utils")
        ...
        if state.file or state.module:
            ...
            if obj:
                ...
                if not click_obj.help:
                    click_obj.help = "Run the provided Typer "
...
@callback(cls=TyperCLIGroup, no_args_is_help=True)
def callback(
    ctx: typer.Context,
    *,
...
def docs(
    ...
    """
    Generate Markdown docs for a Typer 
    """
